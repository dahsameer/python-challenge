...
text = ""
matchobj = re.findall(r'[^A-Z][A-Z]{3}[a-z][A-Z]{3}[^A-Z]', mess, 0)

#the above will find all sequence of words with 1small-3capital-1small-3capital-1small
#i added 1 small on both side because we need to find with exactly 3 capitals on both side
#matchobj will contain list of all these sequences
for words in matchobj:
    text = text + words[4]
    #this will only select the small lettered alphabet from the middle
print(text)